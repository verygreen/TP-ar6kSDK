 ...
 */
#define WLAN_CONFIG_PM_SUSPEND              1// HP Henry: default is 0.
...
/* 
 * HP Henry Li modify
 * add our wifi power function
 */
//#define plat_setup_power(ar, on, detect) /* define as your function */
extern void plat_setup_power_stub(int on) ;
#define plat_setup_power(ar, on, detect) plat_setup_power_stub(on)/* define as your function */
#endif 

...
{
    AR_DEBUG_PRINTF(ATH_DEBUG_ERR,("hif.c - hifAssignTargetHeaders (SDIO_ID=0x%x)\n", SDIO_ID));  
     switch (SDIO_ID) {
...
//hack hack - fix rmmod ar6000 crash isse
/*
    ret = sdio_disable_func(device->func); //die here..
    if (ret) {
        status = A_ERROR;
    } 
*/
